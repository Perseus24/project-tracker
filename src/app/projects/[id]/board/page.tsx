    ...
    return (
        <div className="h-full w-full flex justify-center items-center text-xs">
            <div className="flex flex-col gap-2">
                ...
                <button onClick={() => setCreateTaskButton(true)} className="bg-blue-500 text-white px-4 py-2 rounded-lg cursor-pointer flex gap-2 items-center justify-center text-xs">
                    <TicketPlus size={20} />
                    Create Task</button>
            </div>
            {/* Add Task Modal */}
